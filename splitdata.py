...
googleData = googleData[googleData['Date'] < pd.to_datetime('2018-1-2')]
amazData = amazData[amazData['Date'] < pd.to_datetime('2018-1-2')]
fbData = fbData[fbData['Date'] < pd.to_datetime('2018-1-2')]
