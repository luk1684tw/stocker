...
googleData = googleData[googleData['Date'] < pd.to_datetime('2018-1-3')]
amazData = amazData[amazData['Date'] < pd.to_datetime('2018-1-3')]
fbData = fbData[fbData['Date'] < pd.to_datetime('2018-1-3')]
